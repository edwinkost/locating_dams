...
pgb_ids_file = "/home/edwinaha/github/edwinkost/locating_dams/scripts/merged_waterBodyIds_existing.map"
pgb_ids = pcr.nominal(pcr.readmap(pgb_ids_file))
pgb_ids = pcr.ifthen(pcr.scalar(pgb_ids) > 0.0, pgb_ids)

# IDs based on AHA
aha_ids_file = "/home/edwinaha/github/edwinkost/locating_dams/scripts/future_reservoir_extent_ids.map"
...
pgb_fracWaterInp_file = "/home/edwinaha/github/edwinkost/locating_dams/scripts/merged_fracWaterInp_existing.map"
pgb_resMaxCapInp_file = "/home/edwinaha/github/edwinkost/locating_dams/scripts/merged_resMaxCapInp_existing.map"
pgb_resSfAreaInp_file = "/home/edwinaha/github/edwinkost/locating_dams/scripts/merged_resSfAreaInp_existing.map"
pgb_waterBodyIds_file = "home/edwinaha/github/edwinkost/locating_dams/scripts/merged_waterBodyIds_existing.map"
pgb_waterBodyTyp_file = "home/edwinaha/github/edwinkost/locating_dams/scripts/merged_waterBodyTyp_existing.map"
...
# - fraction water 
aha_fracWaterInp_file = "/home/edwinaha/github/edwinkost/locating_dams/scripts/future_reservoir_fraction_water_ids.map"
aha_fracWaterInp      = pcr.readmap(aha_fracWaterInp_file)
merged_fracWaterInp   = pcr.cover(aha_fracWaterInp, pgb_fracWaterInp)
# - reservoir capacity
aha_resMaxCapInp_file = "/home/edwinaha/github/edwinkost/locating_dams/scripts/future_reservoir_capacity_ids_million_m3.map"
aha_resMaxCapInp      = pcr.readmap(aha_resMaxCapInp_file)
merged_resMaxCapInp   = pcr.cover(aha_resMaxCapInp, pgb_resMaxCapInp)
# - reservoir surface area
aha_resSfAreaInp_file = "/home/edwinaha/github/edwinkost/locating_dams/scripts/future_reservoir_surface_area_ids_m2.map"
...
pcr.report(merged_waterBodyIds, "merged_waterBodyIds_existing_future.map")
pcr.report(merged_fracWaterInp, "merged_fracWaterInp_existing_future.map")
pcr.report(merged_resMaxCapInp, "merged_resMaxCapInp_existing_future.map")
pcr.report(merged_resSfAreaInp, "merged_resSfAreaInp_existing_future.map")
pcr.report(merged_waterBodyTyp, "merged_waterBodyTyp_existing_future.map")
